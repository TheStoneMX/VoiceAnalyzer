    ...
    public ExportSpectrumSVG(Sonogram s) {
        ...
        ActionListener slst = new ActionListener() {
                                  public void actionPerformed(ActionEvent e) {
                                      ...
                                      chooser.setDialogTitle("Selcte SVG file for writting.");
        ...
        cpure.setToolTipText("Export Pure SVG with no specific Sonogram Tags. No reopen with this feature !!!");
        pc.add(cpure);
        p.add(pc);

        slidersize = new JSlider(JSlider.HORIZONTAL,1,10,1);
        slidersize.setBorder(new TitledBorder(new EtchedBorder(),"Graphic Size"));
        slidersize.setToolTipText("Select Graphic Size");
    ...
    public boolean export() {
        ...
        if (width*heigth>30000) {
            ...
            int confirm = JOptionPane.showOptionDialog(this,
                          "This plot is very large.\n" +
                          "Your SVG viewer can have speed problems !\n" +
                          "Spectrum has " + width*heigth + " Elements.\n" +
                          "You can reduce overlapping or set \n" +
                          "samplerate to 8KHz or zoom in !\n" +
                          "Estimated Filesize: " + mes + "MB\n" +
                          "Continue generating of SVG file ?", "Very large plot"
