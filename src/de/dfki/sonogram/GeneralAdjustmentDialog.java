...
class GeneralAdjustmentDialog extends JFrame {
    ...
    JRadioButton   r1,r2,r3,r4,r5,rfft,rlpc;
	...
	,ccepsmooth,cppoints,cplimitfr,cpsmooth,cscrennsaver,cperantialias,cpercoord,cpraway,cptrack,cpfog;
    JTabbedPane    p1;
    JButton        cb;
    JComboBox      wcb;
    Color          bgcol;
    ...
    boolean        cperantialiasconfirm=false;
    ...
    public GeneralAdjustmentDialog (Frame owner) {
        ...
        setTitle("General Options for Sonogram");
        ...
        btro.setToolTipText("Reopen File");
        p3.add(btro);

        btap= new JButton ("ReCalculate");
        ...
        btap.setToolTipText("Apply Changes");
        p3.add(btap);
        ...
        btrd.setToolTipText("Redraw the Sonogram Area");
        p3.add(btrd);
        ...
        sliderwinsize = new JSlider(JSlider.HORIZONTAL,5,12,sono.islws);
        ...
        h1.put (new Integer (5),  new JLabel("32"));
        h1.put (new Integer (6),  new JLabel("64"));
        h1.put (new Integer (7),  new JLabel("128"));
        h1.put (new Integer (8),  new JLabel("256"));
        h1.put (new Integer (9),  new JLabel("512"));
        h1.put (new Integer (10), new JLabel("1024"));
        h1.put (new Integer (11), new JLabel("2048"));
        h1.put (new Integer (12), new JLabel("4096"));
        ...
        cauto     = new JCheckBox ("Automatical searching best Window length",sono.iautowinl);
        ...
        sliderwinfunktion = new JSlider(JSlider.VERTICAL, 1, 7, sono.islwf);
        sliderwinfunktion.setBorder(new TitledBorder(new EtchedBorder(),"Sonogram Window Function"));
        sliderwinfunktion.setToolTipText("<html>Select the Window Function multiplied<br>with the sample window");
        Hashtable h2 = new Hashtable();
        h2.put (new Integer (1), new JLabel("Hamming"));
        h2.put (new Integer (2), new JLabel("Hanning"));
        h2.put (new Integer (3), new JLabel("Blackman"));
        h2.put (new Integer (4), new JLabel("Rectangle"));
        h2.put (new Integer (5), new JLabel("Triangle"));
        h2.put (new Integer (6), new JLabel("Welch"));
        h2.put (new Integer (7), new JLabel("Gauﬂ"));
        ...
        p.add(sliderwinfunktion);
        wfPanel wf =new wfPanel();
        wf.setBorder(new TitledBorder(new EtchedBorder(),"Preview Scope"));
        ...
        r1 = new JRadioButton("Sonogram Fire Colors");
        group.add(r1);
        p.add(r1);
        ...
        group.add(r3);
        p.add(r3);
        r4 = new JRadioButton("Classical Green Oscilloskop Colors");
        group.add(r4);
        p.add(r4);
        ...
        cinv.setToolTipText("Inverse the Colors in RGB Scale");
        ...
        p.add(cback);
        csmoothsi = new JCheckBox ("Smoot out Single Curve",sono.ismosi);
        ...
        csavescreepos.setToolTipText("<html>Save the screen positions/locations<br>for all windows every time<br>Sonogram terminated");
        p.add(csavescreepos);
        ...
        cssaveconf.setToolTipText("<html>Save the Configuration to XML file <br>every time Sonogram finish");
        p.add(cssaveconf);
        ...
        p.add(csloop);
        csopenlast = new JCheckBox ("Open last File while start",sono.iopenlast);
        csopenlast.setForeground(new Color(108,29,108));
        csopenlast.setToolTipText("Open the last opened file when Sonogram starts net time");
        p.add(csopenlast);
        copenlastwithzoom = new JCheckBox ("Open last File with zoom",sono.ilastwithzoom);
        copenlastwithzoom.setForeground(new Color(108,29,108));
        copenlastwithzoom.setToolTipText("Open last opened file with Zoom the last history.");
        p.add(copenlastwithzoom);
        copenlastwithzoom.setEnabled(csopenlast.isSelected());
        csarrange = new JCheckBox ("Arrange while startup",sono.isarr);
        csarrange.setForeground(new Color(108,29,108));
        csarrange.setToolTipText("Arrange and show windows automaicly if the last file is opened while startup.");
        csarrange.setEnabled(csopenlast.isSelected());
        p.add(csarrange);
        csampl    = new JCheckBox ("Open with 8Khz Samplerate",sono.iopen8);
        csampl.setForeground(new Color(10,115,10));
        csampl.setToolTipText("<html>Reopen the file with a samplerate of 8kHz");
        p.add(csampl);
        cgrid     = new JCheckBox ("Show Grid in Sonogram",sono.igrid);
	sono.gridItem.setState(sono.igrid);
        cgrid.setToolTipText("Enables the grid in the Sonogram main area");
        p.add(cgrid);
        cenergy   = new JCheckBox ("Show Energy Intensivity",sono.ienergy);
        cenergy.setToolTipText("<html>Shows the Shorttime Energy instead of the<br>Aplitude over the Timeline");
        p.add(cenergy);
        ...
        sliderwinspeed.setBorder(new TitledBorder(new EtchedBorder(),"Overlapping Multipler in Steps per Frame"));
        p.add(sliderwinspeed);
        JPanel pov = new JPanel();
        coverlapping = new JCheckBox ("Enable Overlapping",sono.ienov);
        ...
        ps.setBorder(new TitledBorder(new EtchedBorder(),"Rendering Style og the Perspectogram"));
        ...
        cuniverse.setToolTipText("<html>Here the Spehere of Plot is textured<br>with an Universe picture.<br><b>kind of EASTER EGG<b>");
        ps.add(cuniverse);
	...
	cperantialiaslast = sono.iperantialias;
        ...
        cb.setToolTipText("The Color of the Perspektograms Background");
        ...
        h7.put (new Integer (1), new JLabel("Small"));
        h7.put (new Integer (10), new JLabel("Normal"));
        h7.put (new Integer (30), new JLabel("Large"));
        ...
        h3.put (new Integer (1), new JLabel("1/8"));
        h3.put (new Integer (2), new JLabel("1/4"));
        h3.put (new Integer (3), new JLabel("1/2"));
        h3.put (new Integer (4), new JLabel("1/1"));
        ...
        sliderformant.setToolTipText("<html>Sample points used for the FFT Transformation");
        ...
        h4.put (new Integer (1), new JLabel("512"));
        h4.put (new Integer (2), new JLabel("1024"));
        h4.put (new Integer (3), new JLabel("2048"));
        h4.put (new Integer (4), new JLabel("4096"));
        h4.put (new Integer (5), new JLabel("8192"));
        ...
        h5.put (new Integer (7),  new JLabel("128"));
        h5.put (new Integer (8),  new JLabel("256"));
        h5.put (new Integer (9),  new JLabel("512"));
        h5.put (new Integer (10), new JLabel("1024"));
        h5.put (new Integer (11), new JLabel("2048"));
        h5.put (new Integer (12), new JLabel("4096"));
        ...
        h6.put (new Integer (1), new JLabel("1/8"));
        h6.put (new Integer (2), new JLabel("1/4"));
        h6.put (new Integer (3), new JLabel("1/2"));
        h6.put (new Integer (4), new JLabel("1/1"));
        ...
        ccep = new JCheckBox ("Enalble Logarithm Quefrenz",sono.iceplog);
        ...
        h9.put (new Integer (8), new JLabel("256"));
        h9.put (new Integer (9), new JLabel("512"));
        h9.put (new Integer (10), new JLabel("1024"));
        h9.put (new Integer (11), new JLabel("2048"));
        h9.put (new Integer (12), new JLabel("4096"));
        h9.put (new Integer (13), new JLabel("8192"));
        slidercep.setLabelTable (h9);
        slidercep.setBorder(new TitledBorder(new EtchedBorder(),"Samples used for Cepstrum Generation"));
        slidercep.setToolTipText("<html>Select buffer size for the cepstal analyze<br>See the Information Window for the corresponding time");
        p.add(slidercep);
        ...
        cplimitfr.setToolTipText("<html>Remove Pitches in <b>Silent</b> areas"); 
	ppg.add(cplimitfr);
	...
	ps.setLayout(new GridLayout(1,2));
        ...
        hpwl.put (new Integer (0), new JLabel("5"));
        hpwl.put (new Integer (1), new JLabel("10"));
        hpwl.put (new Integer (2), new JLabel("25"));
        hpwl.put (new Integer (3), new JLabel("50"));
        hpwl.put (new Integer (4), new JLabel("100"));
        hpwl.put (new Integer (5), new JLabel("250"));
        sliderpwinlength.setLabelTable (hpwl);
        ps.add(sliderpwinlength);

        sliderpwinshift = new JSlider(JSlider.HORIZONTAL,0,5, sono.isacpws);
        ...
        hpws.put (new Integer (0), new JLabel("1.25"));
        hpws.put (new Integer (1), new JLabel("2.5"));
        hpws.put (new Integer (2), new JLabel("5"));
        hpws.put (new Integer (3), new JLabel("10"));
        hpws.put (new Integer (4), new JLabel("25"));
        hpws.put (new Integer (5), new JLabel("50"));
	...
	sliderpitchmax = new JSlider(JSlider.HORIZONTAL, 200, 5000, sono.isacpmax);
        ...
        sliderpitchmax.setToolTipText("<html>Point Reduction for mass data in<br>the Perspectogram. Very usefully<br>for large Point Clouds<br><b>ALPHA VERSION<b>");
	...
	p1.addTab("AC Based Pitch Estimation",new ImageIcon(Sonogram.class.getResource("small_pitch.gif")),p);
        ...
        hacwl.put (new Integer (0), new JLabel("10"));
        hacwl.put (new Integer (1), new JLabel("25"));
        hacwl.put (new Integer (2), new JLabel("50"));
        hacwl.put (new Integer (3), new JLabel("100"));
        hacwl.put (new Integer (4), new JLabel("250"));
        hacwl.put (new Integer (5), new JLabel("500"));
        hacwl.put (new Integer (6), new JLabel("1000"));
        hacwl.put (new Integer (7), new JLabel("2500"));
        hacwl.put (new Integer (8), new JLabel("5000"));
        ...
        hacws.put (new Integer (0), new JLabel("2.5"));
        hacws.put (new Integer (1), new JLabel("5"));
        hacws.put (new Integer (2), new JLabel("10"));
        hacws.put (new Integer (3), new JLabel("25"));
        hacws.put (new Integer (4), new JLabel("50"));
        hacws.put (new Integer (5), new JLabel("100"));
        hacws.put (new Integer (6), new JLabel("250"));
        hacws.put (new Integer (7), new JLabel("500"));
        hacws.put (new Integer (8), new JLabel("1000"));
        ...
        pwa.add(cwavelines);
        cwfnorm = new JCheckBox ("Normalize the Waveform Alplitude",sono.iwfnorm);
        cwfnorm.setToolTipText("Normalize the Waveform Amplitude to the maximum hight of the indow");
        pwa.add(cwfnorm);
        p.add(pwa);
        ...
        h10.put (new Integer (1), new JLabel("20 ms"));
        h10.put (new Integer (2), new JLabel("50 ms"));
        h10.put (new Integer (3), new JLabel("100 ms"));
        h10.put (new Integer (4), new JLabel("250 ms"));
        h10.put (new Integer (5), new JLabel("0.5 sec"));
        h10.put (new Integer (6), new JLabel("1 sec"));
        h10.put (new Integer (7), new JLabel("2 sec"));
        ...
        rfft = new JRadioButton("FFT - Use Fast Fourier Transform Algorithm for the Sonogram",true);
        rfft.setToolTipText("Use FFT for the main display");
        group2.add(rfft);
        p.add(rfft);
        rlpc = new JRadioButton("LPC - Use Linear Prediction Coefficient Algorithm for the Sonogram");
        rlpc.setToolTipText("Use LPC for the main display");
        group2.add(rlpc);
        p.add(rlpc);
        ...
        clog = new JCheckBox ("Enalble Logarithm Amplitude Scaling",sono.iloga);
        ...
        h8.put (new Integer (1),  new JLabel("Least"));
        h8.put (new Integer (2),  new JLabel("Less"));
        h8.put (new Integer (3),  new JLabel("Middle"));
        h8.put (new Integer (4),  new JLabel("More"));
        h8.put (new Integer (5),  new JLabel("Most"));
        ...
        p = new JPanel();
        p.setLayout(new GridLayout(2,1));
        p.setBorder(new TitledBorder(new EtchedBorder(),"Display Frequencys in Logarithm Scale"));
        ...
        cslogfr = new JCheckBox ("Enalble Logarithm Frequency Scale",sono.ilogf);
        cslogfr.setToolTipText("Logarithmize frequency in sonogramview");
        plof1.add(cslogfr);
        cgrid2     = new JCheckBox ("Show Grid in Sonogram",sono.igrid);
        cgrid2.setToolTipText("Enables grid in sonogramview   Ctrl-G");
        p.add(cgrid2);
        plof1.add(cgrid2);
        sliderlogfr = new JSlider(JSlider.HORIZONTAL,1,20,sono.isllf);
        sliderlogfr.setBorder(new TitledBorder(new EtchedBorder(),"Logarithm Scale Base"));
        sliderlogfr.setMajorTickSpacing(1);
        sliderlogfr.setMinorTickSpacing(1);
        sliderlogfr.setPaintTicks  (true);
        sliderlogfr.setPaintLabels (true);
        sliderlogfr.setSnapToTicks(true);
        sliderlogfr.setToolTipText("Select base for logarithmize frequency achse");
        p.add(plof1);
        p.add(sliderlogfr);
        p1.addTab("Logarithm Frequency",new ImageIcon(Sonogram.class.getResource("small_logfr.gif")),p);
        if (cslogfr.isSelected()==false) {
            sliderlogfr.setEnabled(false);
        ...
        pwa2.setBorder(new TitledBorder(new EtchedBorder(),"Generated Wavelet Octaves"));
        ...
        sliderlogfr.addChangeListener(lst);
    ...
    class DialogListener implements ChangeListener, ActionListener {
		...
		cpfog.setEnabled(cptrack.isSelected());
            ...
            if (e.getSource() == sliderformantlen) {
                ...
                if (sono.spektrumExist==true) {
                    ...
                    if (sono.samplesall < len)
                        sono.messageBox("General Adjustment","Signal to short for this bufferlength",1);
                    else {
                        sono.fv.update();
                        sono.fv.len = len;
                        sono.fv.update();
            ...
            if (e.getSource() == cslogfr) {
                if (marklogfr != cslogfr.isSelected()) {
                    ...
                    sliderlogfr.setEnabled(marklogfr);
		...
		if (cperantialias.isSelected()==true && cperantialiaslast == false && cperantialiasconfirm == false) {
		    ...
		    int confirm = JOptionPane.showOptionDialog(GeneralAdjustmentDialog.this,
				  "Antialiasing with Java3D decreases the Graphic Performace\ndramatically and is not supported on all Operating Systems.\nAre you sure you want enable the Java3D Antialiasing ?"
                                  ,"Really Enable Antialiasing in Java3d ?"
    ...
    public void highLightButton(int highlighted) {
        ...
        if (highlighted > highlightedbutton) {
            if (highlighted == 1) {
                btro.setBorder(btcl.getBorder());
                btap.setBorder(btcl.getBorder());
                btrd.setBorder(BorderFactory.createLineBorder(Color.red));
            }
            if (highlighted == 2) {
                btro.setBorder(btcl.getBorder());
                btap.setBorder(BorderFactory.createLineBorder(Color.red));
                btrd.setBorder(btcl.getBorder());
            }
            if (highlighted == 3) {
                btro.setBorder(BorderFactory.createLineBorder(Color.red));
                btap.setBorder(btcl.getBorder());
                btrd.setBorder(btcl.getBorder());
            }
        }
    ...
    class wfPanel extends JPanel {
	    ...
	    Graphics2D g = (Graphics2D)g1;
            ...
            // paint text
            g.setColor(new Color(120,100,110));
            str  = "Minim. Stopband Att.=" + minimunstoppbandattenuation + "dB";
            g.drawString(str,20,36);
            str  = "Amplitude Side Lobe =" + peakamplitudeofsidelobe + "dB";
            g.drawString(str,20,48);

            // paint the funktion curve
            g.setColor(new Color(210,245,40));
            if (winfunktion == 4) {
                fktvect[0] = fktvect[width-51] = 0.0f;
            }
            for (int x=1;x<(width-50);x++) {
                g.drawLine(x+25,height-30-(int)(fktvect[x-1]*(height-90)),x+25,height-30-(int)(fktvect[x]*(height-90)));
            }
        }
    }
    //=========================================================================================================================
    ...
    class crPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            /**
             * this inner class paints the Color array
             */
            int      height  = getSize().height;
            int      width   = getSize().width;
