    ...
    public ReadConfig(Sonogram sono) {
        try {
            ...
            while((line = rd.readLine()) != null) {
                ...
                if (line.indexOf("SliderLogarithmFrequ")>0) {
                    t1  = line.indexOf("value=");
                    t1 += 7;
                    t2  = line.indexOf("\"",t1);
                    tmp = line.substring(t1,t2);
                    sono.isllf = Integer.parseInt(tmp);
                }
                ...
                if (sono.iopenlast==true && sono.ilastwithzoom==true) {
                    ...
                    if (line.indexOf("SelectedStartPrevious")>0) {
                        ...
                        t2  = line.indexOf("\"",t1);
                        tmp = line.substring(t1,t2);
                        sono.selectedstartpre.add(number,new  Double(tmp));
                    }
                    if (line.indexOf("SelectedWidthPrevious")>0) {
                        ...
                        t2  = line.indexOf("\"",t1);
                        tmp = line.substring(t1,t2);
                        sono.selectedwidthpre.add(number,new  Double(tmp));
                    }
                }
            }
            rd.close();
