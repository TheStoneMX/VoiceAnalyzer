...
public class AutoCorrelationView extends JFrame {
    ...
    class AutoCorrelationPanel extends JPanel {
         ...
         * @param Graphics gr - the pen.
         * @param int posX - coordinate X of the triangle of the baloon.
         * @param int posY - coordinate Y of the triangle of the baloon.
         * @param int maxX - The maximum width of the window is needed to set the tooltip on the regth place.
         * @param String test - the text of to be written in the tooltip.
         * @param boolean defaulttooltip - if the default flag is enabled all other values are ignored and the default tooltip "No Pitch found" will be displayed on the predefined position.
         */
